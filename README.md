...
### 4.2.1 Logistic Regression
 - Түүхэн баримт: Логистик функц нь анх 19-р зуунд хүн амын өсөлтийг загварчлахад ашиглагдаж байсан ч, статистик ангиллын зориулалтаар David Cox 1958 онд албан ёсоор томьёолж хөгжүүлсэн.
 - Зориулалт: Энэ нь хоёртын ангилал (Binary Classification) хийхэд хамгийн өргөн ашиглагддаг суурь алгоритм юм. IMDB датасет дээр шүүмжийг "Эерэг" (1) эсвэл "Сөрөг" (0) байх магадлалыг тооцоход ашиглав.
 - Математик үндэс: Шугаман регрессийн үр дүнг Sigmoid функцээр дамжуулж, гаралтыг 0-ээс 1-ийн хооронд шахаж магадлал болгон хувиргадаг.
   σ(z) = 1 / (1 + e^(-z))
    Энд z=w⋅x+b байна. Хэрэв σ(z)>0.5 байвал "Эерэг", бага бол "Сөрөг" гэж ангилдаг.
...
### 4.2.2 Random Forest
 - Түүхэн баримт: "Random Decision Forests" аргын санааг анх Tin Kam Ho (1995) гаргасан боловч, орчин үеийн хувилбарыг Leo Breiman болон Adele Cutler (2001) нар боловсруулж, барааны тэмдэг эзэмшдэг.
 - Зориулалт: Ганц шийдвэрийн мод (Decision Tree) нь хэт сургалтад (overfitting) өртөмтгий байдаг сул талыг арилгах зорилгоор олон модыг нэгтгэн ашигладаг.
 - Математик үндэс: Энэ нь Bagging (Bootstrap Aggregating) аргыг ашигладаг. Сургалтын өгөгдлөөс санамсаргүй түүвэрлэлт хийж олон тооны мод сургах ба мод бүр хариугаа өгнө. Эцсийн хариуг "Олонхын санал" (Majority Voting) зарчмаар гаргадаг.
   ŷ = mode{ h1(x), h2(x), ..., hB(x) }
   Энэ нь вариацыг (variance) багасгаж, моделийн тогтвортой байдлыг хангадаг.
...
### 4.2.3 AdaBoost
 - Түүхэн баримт: 1996 онд Yoav Freund болон Robert Schapire нар боловсруулсан. Тэд энэхүү бүтээлээрээ 2003 онд "Gödel Prize" хүртсэн нь энэ алгоритмын ач холбогдлыг илтгэнэ.
 - Зориулалт: "Сул" сургагчдыг (Weak Learners - ихэвчлэн гүн биш шийдвэрийн мод) нэгтгэж "Хүчтэй" ангилагч (Strong Classifier) болгох зорилготой. Энэ нь өмнөх алхмын алдаан дээрээ суралцдаг тул нарийн төвөгтэй өгөгдөл дээр сайн ажилладаг.
 - Математик үндэс: Энэ нь давталт бүрт өмнөх моделийн буруу таасан өгөгдлийн жинг (weight) нэмэгдүүлж, дараагийн модель тэрхүү "хэцүү" өгөгдөл дээр төвлөрөх боломжийг олгодог. Эцсийн таамаглал нь бүх сул моделиудын жигнэсэн нийлбэр байна:
   F(x) = sign( Σ_{t=1..T} α_t · h_t(x) )
...
Энэхүү судалгаанд IMDB Movie Reviews датасет дээр 7 төрлийн embedding болон 2 төрлийн машин сургалтын загварыг системтэйгээр туршиж, sentiment analysis-ийн гүйцэтгэлд хэрхэн нөлөөлж байгааг судалсан. 
...
3. Тайлбарлах боломжтой AI (Explainable AI):
...
**Энэхүү NLP хичээлийн даалгавар судалгаараар embedding, cross-validation, bert model-уудын тухай туршилтаас судалж суралцлаа. Sentiment analysis даалгавар нь киноны шүүмж дээр positive, negative гэсэн хоёр төрлөөр ангиллаж байсан бол энэ судалгааг цааш нь хөгжүүлж model-д emotion сургах туршилт хийх боломжийг олж харлаа. Embedding чанар нь model-ийн өгүүлбэрийг зөв ойлгож сурахтай шууд хамааралтай тул анхаарах, model-ийн сонголтод суралцах, hyperparameter-ees хамаарсан validation өсөлт(миний хувьд learning rate ээ өөрчилж олон удаа сургалт хийж үзсэн. Гэхдээ сургалтыг дахин дахин явуулсанаар цаг их алдсан) зэрэг нь сайн үр дүнд хүрэх гол хүчин зүйлс болохыг ойлгож туршилтаар баталсан. Мөн өмнө нь иймэрхүү олон төрлийн харьцуулалт хийх даалгавар хийж байгаагүй тул бага зэрэг хүндрэлтэй байсан. Ялангуяа Word2Vec болон classifier-tuning хйих нь толгой эргэмээр байсан, classifier-tuning үр дүн 4. MLP (Neural Net) - 0.8314 (83.14%) 1. Logistic Regression  - 0.8280 (82.80%)
3. AdaBoost             - 0.8011 (80.11%)
2. Random Forest        - 0.7886 (78.86%) гарсан ба сургалтын явцад цаг хугацаа их алдсан ба тайландаа нарийн дурдаж дүгнэлт харьцуулалт бичиж чадаагүй. Мөн зарим туршилтыг цаг хугацааны давчуу байдлаас болж алгассан тул амралтын хугацаанд дэлгэрүүлж суралцах хүсэлтэй байгаа. Дараачын хамгийн чухал асуудал болох model-ын үр дүнг сайжруулах тал дээр сайн анхаарч чадаагүй ба үүнийг ч бас амралтын хугацаанд нарийвчлан судлаж судалгааны үр дүнг сайжруулах бодолтой байна. Сургалтыг чанартай бөгөөд хурдан явуулахад техникийн хүндрэлүүд тулгарч байсан нь GPU-ны асуудал юм. Үүнийг Google colab орчиныг ашиглан шийдсэн ч дутагдалтай тал мөн байсан. Энэ бүхэнд үндэслэн амралтын хугацаанд туршилтуудаа гүнзгийрүүлэн, илүү оновчтой загвар, хурдан бөгөөд чанартай сургалтын арга барилд төвлөрөн судалгаагаа сайжруулах зорилт тавьж байна.**
